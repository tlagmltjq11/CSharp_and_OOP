...
## throw
try 블럭에서 Exception이 발생하였는데 이를 catch 문에서 잡었다면, Exception은 이미 처리된 것으로 간주된다.<br>
...
catch에서 잡은 ex 객체를 MyException의 InnerException에 포함시키고 있다. FileNotFoundException이 발생한 경우는 throw ex 와 같이<br>
호출하고 있는데, 이는 throw ex 까지의 이전 콜스택을 제거하기 때문에 throw ex 이후부터의 콜스택 정보만을 전달하게 된다.<br>
...
https://mandy8303.tistory.com/18<br>
<br>
<br>
