...
공부를 하는 것과 숨 쉬는 것의 기능을 재사용하고, name 필드도 상위 클래스의 것을 재사용함으로써 하위 클래스만의 기능에 집중할 수 있게 되었다.
...
다형성 구현 방식으로 오버로딩, 오버라이딩, 함수형 인터페이스등이 있지만, 사실 오버라이딩 없는 상속만 사용해도 다형성의 의미를 살릴 수 있다.
